...
export const apiContextPath = '/apiPath/'; // http://10.30.0.99:8090/'; // 'http://10.10.254.243:8090/'; // 
const webSocketPath = 'ws://10.10.254.243:8090/'; // 'ws://10.30.0.99:8090/'; // 
...
// WebSocket
export function startupWebSocket(callback){
